                ...
                @foreach ($posts as $post)
                    <li>
                        ...
                        <article class=" transition duration-350 ease-in-out text-black ">
                                            ...
                                            <div x-show="isOpen"
                                                ...
                                                <div class="py-2" role="none">
                                                    ...
                                                    <div x-show="isEditing"
                                                        ...
                                                        class="fixed w-[600px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg p-6 z-50 w-128">
                                                        <!-- Modal content -->
                            ...
                            <div class="pl-16">
                                <p class="text-base width-auto font-medium  flex-shrink">{{ $post->descrip }}
                                    {{-- {{ $post->descrip }} <a href="#" class="text-blue-400">#100DaysOfCode</a>
                                    I was wondering what I can do with <a href="#"
                                        class="text-blue-400">#tailwindcss</a>,
                                ...
                                <div class="md:flex-shrink pr-6 pt-3">
                                    {{-- <div class="bg-cover bg-no-repeat bg-center rounded-lg w-full h-64"
                                        style="height: 200px; background-image: url('{{ 'assets/posts/your_image_name.jpg'}}');">
                                    </div> --}}
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="flex items-center space-x-2 mt-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-500 text-sm">I can't handle the cuteness! Where can I get
                                                one?
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-2 mt-2 ml-6">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-500 text-sm">That little furball is from a local shelter.
                                                You
                    ...
                    <div class="flex flex-1">
                        <div style="margin-top: -6rem;">
                            <div style="height:9rem; width:9rem;" class="md rounded-full relative avatar">
                                <img style="height:9rem; width:9rem;"
                                    class="md rounded-full relative border-2 border-gray-900"
                                    src="/uploads/<?php echo $data['profile_picture']; ?>" alt="">
                                <div class="absolute"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="text-gray-600 flex">
                            ...
                            <span class="flex mr-2"><svg viewBox="0 0 24 24" class="h-5 w-5 paint-icon">
                                    ...
                                    <?php $dateValue = $data['create_at'];
                                    // $dateValue = '2012-01-05';
                                    $time = strtotime($dateValue);
                                    $month = date('F', $time); // January
                                    $year = date('Y', $time); // 2012
                                    echo "$month" . ',' . "$year";
                                    ?>
                                </span></span>
                        </div>
                ...
                <article class="transition duration-350 ease-in-out">
                    <div class="flex flex-shrink-0 p-4 pb-0">
                        <div class="flex-shrink-0 group block">
                            <div class="flex items-center">
                                <a>
                                    <img class="inline-block h-10 w-10 rounded-full" src="/uploads/<?php echo $data['profile_picture']; ?>"
                                        alt="">
                                </a>
                                <div class="ml-3">
                                    <p class="text-base leading-6 font-medium ">
                                        ...
                                        <span
                                            class="text-sm leading-5 font-medium  transition ease-in-out duration-150">
                                            <?php echo $data['username']; ?>
                                            <?php $dateValue = $data['post_timedate'];
                                            $time = strtotime($dateValue);
                                            $month = date('F', $time); // January
                                            $day = date('j', $time); // Day without leading zeros
                                            
                                            echo "$day $month"; // Output: 5 January
                                            ?>
                                ...
                                <div class="ml-[340px]">
                                    <div x-data="{ isOpen: false, isDeleting: false, isEditing: false }" class="relative inline-block text-left">
                                        ...
                                        <div x-show="isOpen"
                                            ...
                                            @click.away="isOpen = false; isDeleting = false; isEditing = false"
                                            @keydown.escape.window="isOpen = false; isDeleting = false; isEditing = false"
                                            class="absolute right-0 z-10 w-48 origin-top-right rounded-md bg-white
                                            ...
                                            <div class="py-2" role="none">
                                                ...
                                                <button
                                                    class="bg-red-500 w-44 mb-1 mr-2 ml-2 opacity-75 hover:opacity-100 text-black-900 hover:text-gray-900 rounded-full px-4 py-2 font-semibold"
                                                    type="button" @click="isDeleting = true">DELETE</button>
                                                <div x-show="isDeleting"
                                                    class="fixed top-0 right-0 bottom-0 left-0 bg-black bg-opacity-50 z-20"
                                                    @click="isOpen = false; isDeleting = false"></div>
                                                ...
                                                <div x-show="isDeleting"
                                                    ...
                                                    <div class="flex justify-center items-center space-x-4">
                                                        ...
                                                        <a href="/posts/delete?post_id=<?php echo $data['post_id']; ?>">
                                                            <button type="submit"
                                                                class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                                                Yes, I'm sure
                                                            </button>
                                                ...
                                                <div x-show="isEditing"
                                                    ...
                                                    <div class="relative p-4 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <!-- Modal body -->
                                                            <form class="p-4 md:p-5" enctype="multipart/form-data"
                                                                action="/posts/update?post_id=<?php echo $data['post_id']; ?>"
                                                                method="post">
                                                                <div class="grid gap-4 mb-4 grid-cols-2">
                                                                    <div class="col-span-2">
                                                                        <label for="post_title"
                    ...
                    <div class="pl-16">
                        <p class="text-base width-auto font-medium  flex-shrink">
                            <?php echo $data['post_data']; ?> <a href="#" class="text-blue-400">#100DaysOfCode</a>
                            I was wondering what I can do with <a href="#"
                                class="text-blue-400">#tailwindcss</a>,
                            so
                        ...
                        <div class="md:flex-shrink pr-6 pt-3">
                            <!-- <div class="bg-cover bg-no-repeat bg-center rounded-lg w-full "
                                            style="background-image: url(/uploads/<?php echo $data['post_img']; ?>)">
                                            <img class="opacity-0 w-full h-full"
                                                src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=448&amp;q=80"
                                                alt="">
                                        </div> -->
                            <img class="border rounded-lg" src="/uploads/<?php echo $data['post_img']; ?>">
                        </div>
