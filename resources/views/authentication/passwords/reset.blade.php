                    ...
                    <div class="w-full flex-1 mt-8">
                        ...
                        <div class="mx-auto max-w-xs">
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                @if ($errors->has('email'))
                                    <div class="bg-red-100 border border-red-400 text-red-700 mt-4 px-4 py-3 rounded relative"
                                        role="alert">
                                ...
                                <label for="confirm-password"
                                    class="block mt-4 mb-2 text-sm font-medium text-gray-900">Confirm
                                    Password</label>
