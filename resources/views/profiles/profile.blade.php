                        ...
                        <div style="margin-top: -6rem;">
                            <div style="height:9rem; width:9rem;" class="md rounded-full relative avatar">
                                <img style="height:9rem; width:9rem;"
                                    ...
                                    src="/uploads/profile_picture.jpg" alt="">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <label for="file-upload"
                                                                                    ...
                                                                                    <input id="file-upload"
                                                                                        name="post_img" type="file"
                                                                                        class="sr-only">
                                                                                </label>
                                                                                <p class="pl-1">or drag and drop
                                                                                </p>
                                                                            </div>
                                                                            <p class="text-xs leading-5 text-gray-900">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex items-center space-x-2 mt-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 text-sm">I can't handle the cuteness! Where can I get one?
                                    </p>
                                </div>
                            </div>
